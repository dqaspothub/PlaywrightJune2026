...
test('Locators Test', async({page}) =>{
    ...
    // by role
    // Go to URL
    await page.goto('https://www.google.com/search?q=testers+world');
    await page.getByRole('link',{name:'Images'}).click();

    // by label
    await page.goto('https://www.google.com/');
    await page.getByLabel('Search',{exact:true}).fill('api testing by testers');
    ...
    await page.getByTestId('username').fill('dqaspothub');
